...
- [Box token architecture validated](project_box_token_architecture_validated.md) — scope intent/theme/depth via selectors at color-definition site, keep consumed token names axis-free
