...
export const DOCS_CATEGORIES = [
  ...
  },
  {
    ...
    label: 'Base',
    items: [
      { key: 'box', label: 'Box', sections: DOCS_COMPONENT_SECTIONS },
      { key: 'flex', label: 'Flex', sections: DOCS_COMPONENT_SECTIONS },
      { key: 'grid', label: 'Grid', sections: DOCS_COMPONENT_SECTIONS },
      { key: 'table', label: 'Table', sections: DOCS_COMPONENT_SECTIONS },
    ],
  },
  {
    key: 'controls',
    label: 'Controls',
    items: [{ key: 'button', label: 'Button', sections: DOCS_COMPONENT_SECTIONS }],
  },
]
