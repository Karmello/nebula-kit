  ...
  return (
    <Box maxInlineSize="55rem" display="flex" flexDirection="column" gap={NEB_LENGTH.px_016}>
      <Text>
        ...
        single primitive. Variants, intents and color decisions are all encoded into that component
      ...
      <Text>
        ...
        painting every visual element in your application. This unification makes the entire system
        more coherent and creates a clear sense that every component is crafted from the same
        material.
      </Text>
    </Box>
  )
