...
export default () => {
  ...
  return (
    <Box maxInlineSize="55rem">
      ...
      <Text>
        You are granted a non-exclusive, non-transferable license to use NebulaKit in personal and commercial
        projects, subject to the terms described below.
      </Text>
      ...
      <Section heading="Core and Pro bundles" size="sm">
          ...
          <MarkerList.Item>
            <Text>
              ...
              <Text tag="span" space="end">
                - includes additional components and features and requires an active subscription and a valid
                license key, pricing details are available on
              </Text>
              <Link
        ...
        <Spacer blockSize="10px" />
        <Text>
          Access to Pro features is granted only while a valid license key is active. If the license key is
          revoked access to Pro components ends immediately.
        </Text>
      </Section>
      <Spacer blockSize="30px" />
      <Section heading="Ownership" size="sm">
        <Text>
          All rights, title and interest in NebulaKit, including its source code, documentation and related
          assets, remain the exclusive property of the author.
        </Text>
      </Section>
      <Spacer blockSize="30px" />
      <Section heading="No warranty" size="sm">
        <Text>
          NebulaKit is provided "as is", without warranty of any kind, express or implied. You assume all risk
      ...
      <Section heading="Changes" size="sm">
        <Text>
          License terms may be updated over time. Continued use of NebulaKit constitutes acceptance of the
