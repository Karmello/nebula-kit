...
export default () => {
  return (
    <Box maxInlineSize="55rem">
      <Text>
        NebulaKit relies heavily on the slot approach for structuring components. You'll see it
        throughout the library - it's one of the core patterns behind how layouts and composite
        elements are built.
      </Text>
      <Spacer blockSize={NEB_LENGTH.px_016} />
      <Text>
        Slots define where content goes. Some slots accept only a single instance, while others can
        be used multiple times within the same component.
      </Text>
      <Spacer blockSize={NEB_LENGTH.px_016} />
      <Text>
        Certain slots are required for a component to render correctly, while others are optional,
        letting you extend or adjust structure without extra wrappers.
      </Text>
      <Spacer blockSize={NEB_LENGTH.px_016} />
      <Text>
