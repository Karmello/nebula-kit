    ...
    <Box maxInlineSize="55rem">
      <Box display="flex" flexDirection="column" gap={NEB_LENGTH.px_016}>
        <Text>
          ...
          tied to a single HTML tag, it is fixed internally and not configurable from the outside.
          In some cases, multiple tags are exposed through the elemTag prop on a component, but only
          when this is valid from an accessibility point of view.
        </Text>
        <Text>
          When you choose a tag, the type of the elemAttrs prop is automatically adjusted so that
          the correct native element properties for that tag are available. This is achieved through
