    ...
    <Box maxInlineSize="55rem">
      <Box display="flex" flexDirection="column" gap={NEB_LENGTH.px_016}>
        <Text>
          ...
          In some cases, multiple tags are exposed through the tag prop on a component, but only
          when this is valid from an accessibility point of view.
        </Text>
        <Text>
          When you choose a tag, the type of the tagAttrs prop is automatically adjusted so that the
