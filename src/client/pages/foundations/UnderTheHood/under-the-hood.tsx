    ...
    <Box maxInlineSize="55rem">
      ...
      <Section heading="CSS and Sass" intent="primary" size="md">
        <Text intent="neutral">
          ...
          simplicity. CSS variables handle color, scale and state, while Sass structures themes and
          utilities cleanly.
        </Text>
      </Section>
      <Spacer blockSize={NEB_LENGTH.px_024} />
      <Section heading="Vite" intent="primary" size="md">
        <Text intent="neutral">
          ...
          TypeScript integration. It keeps the feedback loop fast and the configuration lightweight.
        </Text>
      </Section>
      <Spacer blockSize={NEB_LENGTH.px_024} />
      ...
      <Section heading="Code quality and formatting" intent="primary" size="md">
        <Text intent="neutral">
          Linting and formatting are managed by ESLint and Prettier, keeping the codebase consistent
          and readable. Every component adheres to shared rules, minimizing noise and friction.
        </Text>
      </Section>
    </Box>
  )
