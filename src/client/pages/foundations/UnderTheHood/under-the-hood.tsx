  ...
  return (
    <Box maxInlineSize="55rem">
      <Text>
        ...
        system supports the same principle that guides its design - structure over sprawl. Each of these tools
        was selected not to add complexity, but to preserve it - a stack built for speed, structure and
        long-term clarity.
      </Text>
