    ...
    <Box maxInlineSize="55rem">
      <Box display="flex" flexDirection="column" rowGap={NEB_LENGTH.px_032}>
        ...
        <Box>
          ...
          <Spacer blockSize={NEB_LENGTH.px_006} />
          <Text intent="neutral">
            The library is built on the modern React rendering model introduced in React 18,
            including updated event semantics, stable hook behavior and concurrent-safe updates.
            NebulaKit does not rely on any React-19-specific features, so it remains compatible with
            current and future React releases as long as they maintain React 18's foundational APIs.
          </Text>
        </Box>
        <Box>
          <Text typography="h6" bold color="blue" intent="primary">
          ...
          <Box display="flex" flexDirection="column" rowGap={NEB_LENGTH.px_024}>
            <Box>
              ...
              <Text intent="neutral">
                ...
                support for Vite and Webpack 5. These bundlers handle ESM, TypeScript and CSS
                modules in a way that aligns with NebulaKit's architecture and build outputs.
              </Text>
            </Box>
            <Box>
              <Text intent="neutral" bold>
            ...
            <Box>
              ...
              <Text intent="neutral">
                ...
                loading via style-loader and css-loader. Once configured, usage is identical to
                Vite.
              </Text>
            </Box>
            <Box>
            ...
            <Box>
              ...
              <Spacer blockSize={NEB_LENGTH.px_006} />
              <Text intent="neutral">
                Create React App (CRA) is deprecated and not officially supported. NebulaKit may
                work, but we recommend migrating to a newer bundling environment.
              </Text>
            </Box>
          </Box>
        </Box>
