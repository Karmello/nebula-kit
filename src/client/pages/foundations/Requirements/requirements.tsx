...
export default () => {
  return (
    <Box maxInlineSize="55rem">
      <Section size="sm" heading="React compatibility">
        <Text>NebulaKit requires React 18 or newer.</Text>
        <Spacer />
        <Text>
      ...
      <Spacer blockSize={30} />
      <Section size="sm" heading="Node compatibility">
        <Text>NebulaKit requires Node.js 18 or newer.</Text>
        <Spacer />
        <Text>
