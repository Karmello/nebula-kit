...
export default () => {
    ...
    <Box maxInlineSize="55rem">
      <Box display="flex" flexDirection="column" rowGap={NEB_LENGTH.px_032}>
        ...
        <Box>
          ...
          <HorizontalRule marginTop={NEB_LENGTH.px_004} marginBottom={NEB_LENGTH.px_012} />
          <Text>
            A styling island is complete only when both context and surface are defined. Setting
            theme alone changes how colors are interpreted, but does not create a visible surface.
          </Text>
          <Spacer blockSize={NEB_LENGTH.px_008} />
  ...
  ...
          ...
          <Text>
            ...
            colors. Without a surface, they may still render on the parent background, which can
            lead to:
          </Text>
          <Spacer blockSize={NEB_LENGTH.px_008} />
          <MarkerList>
          ...
          <Text>
            ...
            backgrounds are not recommended, as they can interfere with contrast and distort
            component states. If a colored surface is needed, prefer subtle tones.
          </Text>
        </Box>
      </Box>
    </Box>
