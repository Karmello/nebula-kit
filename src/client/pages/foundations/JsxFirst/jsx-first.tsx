  ...
  return (
    <Box maxInlineSize="55rem" display="flex" flexDirection="column" gap={NEB_LENGTH.px_016}>
      <Text>
        ...
        files, writing tags and customizing them via React props. This does not mean it is CSS-free
        or that you cannot use CSS at all. It simply means NebulaKit is designed in a way that
        encourages developers to work within a single context, staying as productive as possible
      ...
      <Text>
        ...
        to hook into your own CSS stylesheet. However, direct CSS overrides are not recommended and
        are intentionally discouraged, as they may interfere with how NebulaKit's internal styling
        engine works and can introduce unexpected behavior.
      </Text>
    </Box>
  )
}
