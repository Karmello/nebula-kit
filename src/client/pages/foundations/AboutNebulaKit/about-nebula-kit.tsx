...
export default () => {
  return (
    <Box maxInlineSize="55rem">
      <Text>
        NebulaKit is built for forward motion. It gives you a foundation that helps you move instead of
        slowing you down. The system makes the early choices that matter - structure, spacing, motion,
        interaction - so you can focus on building features instead of re-engineering fundamentals. You don't
        start with a blank canvas. You start with a framework that already knows how it wants to behave.
        Layout, colors - every layer speaks the same design language. That consistency becomes an accelerant.
      ...
      <Text>
        ...
        trying to be everything. It's a kit for building real apps quickly and confidently - the kind teams
