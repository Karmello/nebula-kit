  ...
  return (
    <Box maxInlineSize="55rem">
      <Text>
        ...
        structure, gravity pulling fragments into order.
      </Text>
      <Spacer blockSize={15} />
      <Text>
      ...
      <Spacer blockSize={15} />
      <Text>
        Each primitive is a particle, small and clear in its purpose. Together they compose larger shapes -
        predictable, balanced, alive. The system doesn't fight complexity, it organizes it.
      </Text>
      <Spacer blockSize={15} />
      <Text>
        Like a nebula collapsing into a star, everything here begins loosely connected and ends in clarity.
        From Box to Flex to Grid, every layer follows the same gravitational rules. Design and code settle
        into the same orbit.
      </Text>
      <Spacer blockSize={15} />
      <Text>
