export const PRICING_DATA = {
  ...
  additionalInfo: [
    ...
    '* As NebulaKit evolves with new components, features and long-term improvements, pricing may change over time to reflect the growing value of the system. Any updates will always be communicated in advance.',
    '* All prices in USD.',
  ],
}
