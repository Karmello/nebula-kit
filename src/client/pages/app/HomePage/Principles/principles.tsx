  ...
  return (
    <>
      <Grid gridTemplateColumns={{ base: '1fr', md: 'repeat(2, 1fr)', lg: '1fr' }} gap="30px">
        <Section heading="JSX first" color="green" intent="secondary" iconName="code">
          <Text intent="neutral">
            JSX is the primary development flow. CSS exists mainly as an internal implementation detail.
          </Text>
        </Section>
        <Section heading="Built on composition" color="green" intent="secondary" iconName="rectangle-circle">
          <Text intent="neutral">Pure composition drives all component behavior. Functionality is never duplicated.</Text>
        </Section>
        <Section heading="Inheriting props" color="green" intent="secondary" iconName="share-2">
          <Text intent="neutral">Composed functionality flows through prop inheritance, not redefinition.</Text>
        </Section>
        <Section heading="Enforcing semantics" color="green" intent="secondary" iconName="file-code">
          <Text intent="neutral">Semantic HTML is part of the component contract.</Text>
        </Section>
        <Section heading="Orthogonal styling axes" color="green" intent="secondary" iconName="atom">
          <Text intent="neutral">Styling concerns are separated and scoped to prevent interference.</Text>
        </Section>
        <Section heading="Unified drawing model" color="green" intent="secondary" iconName="paintbrush">
          <Text intent="neutral">All visual output is produced through a single drawing model.</Text>
        </Section>
        <Section heading="Unified responsiveness" color="green" intent="secondary" iconName="tablet-smartphone">
          <Text intent="neutral">Responsive behavior follows a single explicit model.</Text>
        </Section>
        <Section heading="Resistant to entropy" color="green" intent="secondary" iconName="shield-check">
