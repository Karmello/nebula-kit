  ...
  return (
    <Reveal scale="sm" intent="tertiary" label="Read me">
      <Box padding={NEB_LENGTH.px_016}>
        ...
        <Text>
          The website reflects how NebulaKit is intended to be used in practice. Some surfaces
          inherit the active brand, while others define their color locally for semantic or
          contextual reasons.
        </Text>
      </Box>
    </Reveal>
