...
import { GridProps } from 'lib/components/core/layout/Grid'
...
const GRID_EXAMPLES_META: ComponentMeta<GridProps>['examples'] = [
  {
    ...
    jsx: (
      <Grid gridTemplateColumns="2fr 1fr">
        <Box drawable tag="article" variant="outline" color="blue" intent="primary">
          Article
        </Box>
        <Box drawable tag="aside" variant="outline" color="blue" intent="primary">
          Aside
        </Box>
      </Grid>
    ),
