...
export const USE_FADE_OVERVIEW: DocOverview = {
  ...
  description:
    'useFade applies opacity-based motion directly to the DOM element referenced by ref, smoothly transitioning it between visible and hidden states. It is intended for lightweight visual transitions such as overlays, tooltips, floating UI and subtle content reveals.',
  features: [
