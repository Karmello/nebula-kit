...
export const useNebkitStore = create<NebkitState>()(
  persist(
    set => ({
      ...
      borderWidth: NEBKIT_PROVIDER_SIZES_MAP.borderWidthSize[DEFAULT_NEBKIT_PROVIDER_BORDER_WIDTH_SIZE],
      borderRadius: NEBKIT_PROVIDER_SIZES_MAP.borderRadiusSize[DEFAULT_NEBKIT_PROVIDER_BORDER_RADIUS_SIZE],
      setTheme: theme => set({ theme }),
      setBrand: brand => set({ brand }),
      setBorderWidthSize: borderWidthSize =>
        set({ borderWidthSize, borderWidth: NEBKIT_PROVIDER_SIZES_MAP.borderWidthSize[borderWidthSize] }),
      setBorderRadiusSize: borderRadiusSize =>
        set({ borderRadiusSize, borderRadius: NEBKIT_PROVIDER_SIZES_MAP.borderRadiusSize[borderRadiusSize] }),
    }),
    {
