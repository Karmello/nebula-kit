...
export const THEME_BACKGROUNDS_MAP: Record<ThemeBackgroundColor, object> = {
  white: {
    ...
    '--neb-neutral-outline-border': 'var(--neb-gray-2)',
    '--neb-neutral-outline-border-hover': 'var(--neb-gray-3)',
    '--neb-neutral-outline-border-active': 'var(--neb-gray-5)',
  ...
  black: {
    ...
    '--neb-neutral-solid-bg': 'var(--neb-gray-9)',
    '--neb-neutral-solid-bg-hover': 'var(--neb-gray-8)',
    '--neb-neutral-solid-bg-active': 'var(--neb-gray-7)',
    '--neb-neutral-outline-border': 'var(--neb-gray-8)',
    '--neb-neutral-outline-border-hover': 'var(--neb-gray-7)',
    '--neb-neutral-outline-border-active': 'var(--neb-gray-6)',
    '--neb-neutral-outline-bg-active': 'var(--neb-gray-8)',
    '--neb-inverse-solid-bg': 'var(--neb-gray-4)',
    '--neb-inverse-solid-bg-hover': 'var(--neb-gray-3)',
    ...
    '--neb-inverse-outline-text': 'var(--neb-gray-1)',
