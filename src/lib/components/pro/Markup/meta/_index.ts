...
import { MARKUP_EXAMPLES_META } from './examples'
import { MARKUP_PROPS_META } from './props'

const MARKUP_META: ComponentMeta<MarkupProps> = {
  overview: {
    bundle: 'pro',
  ...
  props: MARKUP_PROPS_META,
  examples: MARKUP_EXAMPLES_META,
  changelog: {
    '0.10.0': ['released'],
  },
}
