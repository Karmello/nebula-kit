...
import { BUTTON_SIZE_MAP } from 'lib/components/core/controls/Button/definitions'
...
export const Switch = ({
  ...
  const resolvedBlockSize = resolveLengthValue(BUTTON_SIZE_MAP[size || 'md'].blockSize)
