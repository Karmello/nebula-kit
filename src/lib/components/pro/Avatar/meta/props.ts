...
import { type AvatarProps, AVATAR_SHAPES, AVATAR_SIZES, DEFAULT_AVATAR_SHAPE, DEFAULT_AVATAR_SIZE } from '../definitions'
import { IMAGE_PROPS_META } from '../../../core/Image/meta/props'
